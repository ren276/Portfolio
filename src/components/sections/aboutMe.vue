  ...
  >
    <div class="md:column-gap grid grid-cols-12">
      ...
      <h3
        ...
        v-html="aboutMe"
        class="heading-4 lg:heading-3 section-heading col-span-full py-4 font-extrabold uppercase md:col-span-7 md:col-start-6"
      ></h3>
    </div>
...
<script setup lang="ts">
  ...
  import { profile as profile2 } from '@/assets/images';
  ...
  onBeforeMount(() => {
    aboutMe.value = textSplitterIntoChar(
      'Software Engineer, Mobile Developer, Product Engineer/',
      true,
      false,
    );
  });
