  ...
  <section id="research-and-patents" class="common-padding mb-20">
    ...
    <div class="relative mt-12 w-full lg:mt-[10%]">
      <div class="grid grid-cols-1 gap-10 md:grid-cols-2">
        ...
        >
          <!-- Card area -->
          <a class="group" target="_blank" :href="item.url || '#'">
            <div class="mt-4">
              <p class="heading-6 font-title! mb-2 leading-none text-flax-smoke-400">
                {{ item.category }}
              </p>
              <div class="flex flex-col gap-4">
                <h3 class="heading-3 font-title! font-bold uppercase leading-tight text-flax-smoke-100">
                  {{ item.name }}
                </h3>
                <div class="flex flex-wrap gap-1.5 select-none">
                  <p
                    class="border-flax-smoke-300 hover:bg-flax-smoke-300 hover:text-flax-smoke-900 text-flax-smoke-200 rounded-full border px-4 py-2 transition-[background-color,color] duration-500 ease-in-out"
          ...
          <Transition name="details-slide">
            ...
            >
              ...
              <div class="mb-4">
                ...
                <p class="text-flax-smoke-200 text-sm leading-relaxed">{{ item.details.overview }}</p>
              </div>
              ...
              <div v-if="item.details.techStack" class="mb-4">
                ...
                <p class="text-flax-smoke-200 text-sm leading-relaxed">{{ item.details.techStack }}</p>
              </div>

              <!-- Achievements -->
              <div v-if="item.details.achievements && item.details.achievements.length" class="mb-4">
                <p class="heading-6 text-flax-smoke-400 mb-2 uppercase tracking-widest">Key Points</p>
              ...
              <!-- Links -->
              <div v-if="item.details.links && item.details.links.length" class="flex flex-wrap gap-2 pt-1">
                <a
