...
const resourceLinks = [
  {
    label: 'Resume',
    url: 'https://drive.google.com/file/d/1FJAB3BEwyZxEQwBxaxRJtRVYyk0Db3k8/view?usp=sharing',
  },
  {
...
const heroText = 'Mobile & Full-Stack Developer | Android · iOS · Flutter · AI/ML';
...
export const aboutMeText1 = "I'm a Computer Science Engineering graduate from GGSIPU (9.16 CGPA) with hands-on experience building mobile apps at scale. I've worked as an SDE-1 at NAVAN, built cross-platform apps using Flutter, and published AI/ML research in a Springer journal.";
export const aboutMeText2 = "I hold a filed patent for interactive digital avatars and have led tech communities as CESTA President and GDSC Co-Lead. Proficient in Kotlin, Swift, Python, JavaScript, and modern frameworks like Jetpack Compose, SwiftUI, and Next.js.";
...
export const servicesData = [
  ...
  },
  {
    ...
    headings: ['Next.js, JavaScript', 'PostgreSQL, Redis, SQL', 'Supabase, REST APIs'],
...
export const projectsData = [
  {
    ...
    tags: ['Kotlin', 'Jetpack Compose', 'Supabase', 'Ktor', 'REST API', 'Timber'],
    videoSrc: '',
    imageBg: '',
    ...
    details: {
      ...
      links: [
        { label: 'GitHub', url: 'https://github.com/ren276/strata' },
      ],
    },
  },
  {
...
export const researchAndPatentsData = [
  {
    ...
    year: '2026',
    details: {
      overview: 'Patent No. 202511117683: System for Generating Interactive Digital Avatars. Original systems-level IP contribution.',
      achievements: [
        'Granted in 2026',
  ...
  },
  {
    ...
    year: '2025',
    details: {
      overview: 'Comparative analysis of AssemblyAI vs WhisperAI for software documentation — quantitative NLP evaluation aligned with applied AI research.',
...
export const experienceData = [
  {
    ...
    description: 'Engineered Meal Selection feature for airline checkout using Agile SDLC, Kotlin, and SwiftUI. Improved crash-free users to 95.66% and significantly reduced ANR rates.'
  },
  {
    role: 'Flutter Developer Intern',
    company: 'HeimatVerse, New Delhi',
    duration: 'July 2023 - September 2023',
    description: 'Developed Autumn8 multiplatform Smart Home app using Flutter and Arduino. Improved prototype test speeds by 75% through optimization.'
  }
];
